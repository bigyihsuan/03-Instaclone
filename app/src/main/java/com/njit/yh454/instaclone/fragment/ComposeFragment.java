...
import com.njit.yh454.instaclone.LoginActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.i(TAG, "btnLogout: logging out user " + ParseUser.getCurrentUser().getUsername());
                ParseUser.logOut();
                Log.i(TAG, "btnLogout: logged out");
                goLoginActivity();
                getActivity().finish();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                ImageView ivPicture = (ImageView) getView().findViewById(R.id.ivPicture);
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                Log.i(TAG, "savePost: post save successful");
